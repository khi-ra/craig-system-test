...
{
    private readonly TestCaseLoader _testLoader = loader;
    ...
    public async Task RunAsync(string[] testFiles)
    {
        foreach (string file in testFiles)
        {
            ...
            List<TestCase> tests = _testLoader.Load(filePath);
    ...
    private void PrintEvaluatedTests(TestCase test, EvaluatedTestCase evaluatedTest)
    {
